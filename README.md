...
| Liam Sipp | GUI & Canvas (PyQt6) | `qt_models.py`, `qt_bridge_view.py`, `qt_controller.py`, `qt_main.py`, `widgets/maze_canvas.py`; PyQt6 GUI/canvas implementation, themed HUD and controls, keyboard/button input wiring, and Qt-side presentation layer for the Final Maze phase |
